...
/**
 * `@invana/forms` field schema for the LabelResolutionLODBehaviour editor.
 * Field `name`s match the keys of `LabelResolutionLODFields` 1:1 so the
 ...
 */
export const labelResolutionLodFields: FieldConfig[] = [
  {
    name: 'baseResolution',
    type: 'number',
