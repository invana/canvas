 ...
 * @example
 * ```typescript
 * import { Canvas } from '@invana/canvas-deprecated';
 * import { GraphDataPlugin } from '@invana/plugins-graph-data-deprecated';
 * import { D3ForceLayoutPlugin } from '@invana/plugin-layouts-d3-force-deprecated';
 *
...
import type { GraphDataPlugin } from '@invana/plugins-graph-data-deprecated';
