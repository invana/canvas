...
D3 force-directed graph layout plugin for `@invana/canvas-deprecated`.
...
```typescript
import { Canvas, GraphDataPlugin, PluginRegistry } from '@invana/canvas-deprecated';
...
```typescript
import { Canvas, GraphDataPlugin } from '@invana/canvas-deprecated';
import { D3ForceLayoutPlugin } from '@invana/layouts-d3-force';
