// ── Animation option types (plugins-shapes) ───────────────────────────────────
...
/**
 * Animations to apply to a solid shape element via {@link ShapesPlugin.animate}.
 *
 * @remarks
 ...
 * @example
 * ```ts
 * shapes.animate('s1', { breathe: { amplitude: 0.12, duration: 1667 } });
 *
 ...
 * shapes.clearAnimation('s1', 'breathe');
 * ```
 */
