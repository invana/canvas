...
import type { DrawStyle, PathStyle, LabelStyle } from '@invana/canvas-deprecated';
export type { LabelStyle };
export type { LabelBackgroundStyle, LabelPadding, LabelRenderer } from '@invana/canvas-deprecated';
...
import type { GraphicsPathCommand as PathCommand } from '@invana/canvas-deprecated';
...
// working when importing from @invana/plugins-shapes-deprecated.
