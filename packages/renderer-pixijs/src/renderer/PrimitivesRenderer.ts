...
import { CircleShape } from '../primitives/shapes/CircleShape';
import { EllipseShape } from '../primitives/shapes/EllipseShape';
import { RectShape } from '../primitives/shapes/RectShape';
import { TabbedRectShape } from '../primitives/shapes/TabbedRectShape';
import { PathShape } from '../primitives/shapes/PathShape';
import { PolygonShape } from '../primitives/shapes/PolygonShape';
import { RegularPolygonShape } from '../primitives/shapes/RegularPolygonShape';
import { StarShape } from '../primitives/shapes/StarShape';
import { ArcShape } from '../primitives/shapes/ArcShape';
import { CompositeShape } from '../primitives/shapes/CompositeShape';
...
import { MarchingAntsDecoration } from '../primitives/decorations/shape/MarchingAntsDecoration';
import { RingDecoration } from '../primitives/decorations/shape/RingDecoration';
import { MarchingAntsConnectorDecoration } from '../primitives/decorations/connector/MarchingAntsConnectorDecoration';
import { FlyMarkerConnectorDecoration } from '../primitives/decorations/connector/FlyMarkerConnectorDecoration';
import { FlowParticlesConnectorDecoration } from '../primitives/decorations/connector/FlowParticlesConnectorDecoration';
import { GlowConnectorDecoration } from '../primitives/decorations/connector/GlowConnectorDecoration';
import { RippleConnectorDecoration } from '../primitives/decorations/connector/RippleConnectorDecoration';
import { RevealConnectorDecoration } from '../primitives/decorations/connector/RevealConnectorDecoration';
import { RingConnectorDecoration } from '../primitives/decorations/connector/RingConnectorDecoration';
import { LabelDecoration } from '../primitives/decorations/shape/LabelDecoration';
import { ToggleDecoration } from '../primitives/decorations/shape/ToggleDecoration';
import { ResizeHandleDecoration } from '../primitives/decorations/shape/ResizeHandleDecoration';
import { SelectionFrameDecoration } from '../primitives/decorations/shape/SelectionFrameDecoration';
import { LabelConnectorDecoration } from '../primitives/decorations/connector/LabelConnectorDecoration';
