 ...
 * ```ts
 * declare module '@invana/canvas-deprecated' {
...
export interface CanvasEventMap {
  ...
  // Graph event types are added via module augmentation from @invana/plugins-graph-data-deprecated.
  // See: https://www.typescriptlang.org/docs/handbook/declaration-merging.html
  // Example:
  //   import '@invana/plugins-graph-data-deprecated';  // auto-augments this map
  ...
  // via `declare module '@invana/canvas-deprecated'` — see `plugins-shapes/events-augment.ts`.
}
