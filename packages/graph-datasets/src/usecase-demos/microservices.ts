...
const nodes: readonly MicroservicesNode[] = [
  // ── Edge / gateway ──
  { id: 'api-gateway',           data: { tier: 'gateway',  health: 'healthy',  rps: 5800 } },

  // ── API tier ──
  { id: 'auth-api',              data: { tier: 'api',      health: 'healthy',  rps:  920 } },
  { id: 'user-api',              data: { tier: 'api',      health: 'healthy',  rps: 1200 } },
  { id: 'product-api',           data: { tier: 'api',      health: 'healthy',  rps: 1450 } },
  { id: 'order-api',             data: { tier: 'api',      health: 'degraded', rps:  680 } },
  { id: 'billing-api',           data: { tier: 'api',      health: 'healthy',  rps:  240 } },
  { id: 'search-api',            data: { tier: 'api',      health: 'healthy',  rps:  980 } },

  // ── Logic tier ──
  { id: 'payment-service',       data: { tier: 'logic',    health: 'degraded', rps:  320 } },
  { id: 'notification-service',  data: { tier: 'logic',    health: 'healthy',  rps:  510 } },
  { id: 'recommendation-service',data: { tier: 'logic',    health: 'healthy',  rps:  720 } },
  { id: 'fraud-detector',        data: { tier: 'logic',    health: 'down',     rps:    0 } },
  { id: 'inventory-service',     data: { tier: 'logic',    health: 'healthy',  rps:  280 } },

  // ── Data tier ──
  { id: 'user-db',               data: { tier: 'data',     health: 'healthy',  rps: 2400 } },
  { id: 'order-db',              data: { tier: 'data',     health: 'healthy',  rps: 1100 } },
  { id: 'product-db',            data: { tier: 'data',     health: 'healthy',  rps: 1600 } },
  { id: 'cache',                 data: { tier: 'data',     health: 'healthy',  rps: 4200 } },
  { id: 'queue',                 data: { tier: 'data',     health: 'healthy',  rps: 1800 } },
  { id: 'search-index',          data: { tier: 'data',     health: 'healthy',  rps:  750 } },

  // ── External / SaaS dependencies ──
  { id: 'stripe-adapter',        data: { tier: 'external', health: 'healthy',  rps:  180 } },
  { id: 'ses-mailer',            data: { tier: 'external', health: 'healthy',  rps:  340 } },
];

const edges: readonly MicroservicesEdge[] = [
  // gateway fan-out
