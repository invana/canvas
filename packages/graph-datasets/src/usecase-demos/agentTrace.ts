...
const refundQuery: AgentTraceData = {
  ...
  nodes: [
    { id: 'start',          data: { kind: 'output',   label: 'User: "I was charged twice"', status: 'success', durationMs: 0 } },
    { id: 'classify',       data: { kind: 'llm',      label: 'classifyIntent',              status: 'success', durationMs: 412,  tokens: 184 } },
    { id: 'fetchOrder',     data: { kind: 'tool',     label: 'GET /orders/123',             status: 'success', durationMs: 78 } },
    { id: 'fetchPayments',  data: { kind: 'tool',     label: 'GET /payments?order=123',     status: 'success', durationMs: 91 } },
    { id: 'analyzeCharges', data: { kind: 'llm',      label: 'analyzeCharges',              status: 'success', durationMs: 638,  tokens: 412 } },
    { id: 'decideRefund',   data: { kind: 'decision', label: 'eligible? yes',               status: 'success', durationMs: 12 } },
    { id: 'issueRefund',    data: { kind: 'tool',     label: 'POST /refunds',               status: 'success', durationMs: 204 } },
    { id: 'composeReply',   data: { kind: 'llm',      label: 'composeReply',                status: 'success', durationMs: 521,  tokens: 286 } },
    { id: 'response',       data: { kind: 'output',   label: 'Refund processed ✓',          status: 'success', durationMs: 0 } },
  ],
  edges: [
...
const knowledgeLookup: AgentTraceData = {
  ...
  nodes: [
    { id: 'start',          data: { kind: 'output',   label: 'User: "What\'s our SOC2 policy?"', status: 'success', durationMs: 0 } },
    { id: 'classify',       data: { kind: 'llm',      label: 'classifyIntent',                   status: 'success', durationMs: 387,  tokens: 162 } },
    { id: 'searchKb',       data: { kind: 'tool',     label: 'GET /kb/search → 504',             status: 'error',   durationMs: 5012 } },
    { id: 'retrySearch',    data: { kind: 'tool',     label: 'GET /kb/search (retry)',           status: 'success', durationMs: 142 } },
    { id: 'rankResults',    data: { kind: 'llm',      label: 'rankResults',                      status: 'success', durationMs: 489,  tokens: 318 } },
    { id: 'fetchDoc',       data: { kind: 'tool',     label: 'GET /kb/docs/SOC2 → 404',          status: 'error',   durationMs: 88 } },
    { id: 'fallbackSearch', data: { kind: 'tool',     label: 'GET /kb/search?q=SOC2 compliance', status: 'success', durationMs: 156 } },
    { id: 'summarize',      data: { kind: 'llm',      label: 'summarize',                        status: 'success', durationMs: 712,  tokens: 524 } },
    { id: 'citationCheck',  data: { kind: 'decision', label: 'cited? yes',                       status: 'success', durationMs: 9 } },
    { id: 'response',       data: { kind: 'output',   label: 'Reply with citations',             status: 'success', durationMs: 0 } },
  ],
  edges: [
...
const multiToolDecision: AgentTraceData = {
  ...
  nodes: [
    { id: 'start',         data: { kind: 'output',   label: 'User: "Refactor auth or billing?"', status: 'success', durationMs: 0 } },
    { id: 'classify',      data: { kind: 'llm',      label: 'classifyIntent',                    status: 'success', durationMs: 401,  tokens: 174 } },
    { id: 'fetchRepo',     data: { kind: 'tool',     label: 'GET /repo/stats',                   status: 'success', durationMs: 132 } },
    { id: 'fetchIssues',   data: { kind: 'tool',     label: 'GET /issues?label=tech-debt',       status: 'success', durationMs: 211 } },
    { id: 'fetchOwners',   data: { kind: 'tool',     label: 'GET /codeowners',                   status: 'success', durationMs: 84 } },
    { id: 'analyzeRepo',   data: { kind: 'llm',      label: 'analyzeRepo',                       status: 'success', durationMs: 542,  tokens: 388 } },
    { id: 'analyzeIssues', data: { kind: 'llm',      label: 'analyzeIssues',                     status: 'success', durationMs: 612,  tokens: 442 } },
    { id: 'analyzeOwners', data: { kind: 'llm',      label: 'analyzeOwners',                     status: 'success', durationMs: 318,  tokens: 224 } },
    { id: 'weighOptions',  data: { kind: 'decision', label: 'score: auth > billing',             status: 'success', durationMs: 18 } },
    { id: 'chooseAuth',    data: { kind: 'output',   label: 'Recommend: refactor auth',          status: 'success', durationMs: 0 } },
    { id: 'chooseBilling', data: { kind: 'output',   label: 'Defer: billing',                    status: 'pending', durationMs: 0 } },
    { id: 'composeReply',  data: { kind: 'llm',      label: 'composeReply',                      status: 'success', durationMs: 678,  tokens: 512 } },
    { id: 'response',      data: { kind: 'output',   label: 'Recommendation delivered',          status: 'success', durationMs: 0 } },
  ],
  edges: [
