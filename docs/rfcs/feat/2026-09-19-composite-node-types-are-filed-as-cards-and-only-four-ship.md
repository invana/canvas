...
| **Open decisions** | None — D-1 … D-4 accepted as recommended on 2026-09-19 |
| **Row status** | proposed 0 · accepted 0 · implemented 12 · landed 0 · deferred 0 · rejected 0 — every row is written and green on V1–V5; `landed` waits on V6/V7 (a visual pass) and on reaching `main` |
