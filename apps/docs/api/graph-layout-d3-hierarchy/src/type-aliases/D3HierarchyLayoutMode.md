...
Defined in: [graph-layout-d3-hierarchy/src/types.ts:23](https://github.com/invana/canvas/blob/9082d7c9f5a0b14b8c8220f666d8bd3c74c1d3bd/packages/graph-layout-d3-hierarchy/src/types.ts#L23)
