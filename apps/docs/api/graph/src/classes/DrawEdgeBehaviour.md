...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`DrawEdgeBehaviourOptions`](../interfaces/DrawEdgeBehaviourOptions.md)\>
...
> `protected` **\_options**: [`DrawEdgeBehaviourOptions`](../interfaces/DrawEdgeBehaviourOptions.md)
...
> `readonly` **kind**: `"draw-edge"` = `'draw-edge'`
