...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`ClickInspectBehaviourOptions`](../interfaces/ClickInspectBehaviourOptions.md)\>
...
> `protected` **\_options**: [`ClickInspectBehaviourOptions`](../interfaces/ClickInspectBehaviourOptions.md)
...
> `readonly` **events**: [`EventEmitter`](../../../canvas/src/classes/EventEmitter.md)\<[`ClickInspectEventMap`](../type-aliases/ClickInspectEventMap.md)\>
...
> `readonly` **kind**: `"click-inspect"` = `'click-inspect'`
