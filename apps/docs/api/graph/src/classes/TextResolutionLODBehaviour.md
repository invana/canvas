# Class: TextResolutionLODBehaviour

What `BehaviourRegistry` sees.

## Extends

- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`TextResolutionLODBehaviourOptions`](../interfaces/TextResolutionLODBehaviourOptions.md)\>

## Constructors

### Constructor

> **new TextResolutionLODBehaviour**(`opts`): `TextResolutionLODBehaviour`
...
> `protected` **\_options**: [`TextResolutionLODBehaviourOptions`](../interfaces/TextResolutionLODBehaviourOptions.md)
...
> `readonly` **kind**: `"label-resolution-lod"` = `'label-resolution-lod'`
...
and reset the tier index so apply climbs the (possibly reshaped)
