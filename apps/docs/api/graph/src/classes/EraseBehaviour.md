...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`EraseBehaviourOptions`](../interfaces/EraseBehaviourOptions.md)\>
...
> `protected` **\_options**: [`EraseBehaviourOptions`](../interfaces/EraseBehaviourOptions.md)
