...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`DragNodeBehaviourOptions`](../interfaces/DragNodeBehaviourOptions.md)\>
...
> `protected` **\_options**: [`DragNodeBehaviourOptions`](../interfaces/DragNodeBehaviourOptions.md)
...
> `readonly` **kind**: `"drag-node"` = `'drag-node'`
