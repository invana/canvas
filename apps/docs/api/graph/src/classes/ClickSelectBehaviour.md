...
> `readonly` **events**: [`EventEmitter`](../../../canvas/src/classes/EventEmitter.md)\<[`ClickSelectEventMap`](../type-aliases/ClickSelectEventMap.md)\>
...
> `readonly` **kind**: `"click-select"` = `'click-select'`
