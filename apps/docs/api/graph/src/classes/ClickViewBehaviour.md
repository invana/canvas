...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`ClickViewBehaviourOptions`](../interfaces/ClickViewBehaviourOptions.md)\>
...
> `protected` **\_options**: [`ClickViewBehaviourOptions`](../interfaces/ClickViewBehaviourOptions.md)
...
> `readonly` **events**: [`EventEmitter`](../../../canvas/src/classes/EventEmitter.md)\<[`ClickViewEventMap`](../type-aliases/ClickViewEventMap.md)\>
...
> `readonly` **kind**: `"click-view"` = `'click-view'`
