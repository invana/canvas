...
> `readonly` **events**: [`EventEmitter`](../../../canvas/src/classes/EventEmitter.md)\<[`HoverElementPreviewEventMap`](../type-aliases/HoverElementPreviewEventMap.md)\>
...
> `readonly` **kind**: `"hover-element-preview"` = `'hover-element-preview'`
