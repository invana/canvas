...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`CollapseExpandBehaviourOptions`](../interfaces/CollapseExpandBehaviourOptions.md)\>
...
> `protected` **\_options**: [`CollapseExpandBehaviourOptions`](../interfaces/CollapseExpandBehaviourOptions.md)
...
> `readonly` **kind**: `"collapse-expand"` = `'collapse-expand'`
