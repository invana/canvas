# Class: EdgeScaleLODBehaviour

## Extends

- `ElementScaleLODBehaviour`\<[`EdgeScaleLODBehaviourOptions`](../interfaces/EdgeScaleLODBehaviourOptions.md)\>

## Constructors

### Constructor

> **new EdgeScaleLODBehaviour**(`opts`): `EdgeScaleLODBehaviour`
...
`ElementScaleLODBehaviour<EdgeScaleLODBehaviourOptions>.constructor`
...
> `protected` **\_options**: [`EdgeScaleLODBehaviourOptions`](../interfaces/EdgeScaleLODBehaviourOptions.md)
...
> `readonly` **kind**: `"edge-size-lod"` = `'edge-size-lod'`
