...
> **new NodeCentralityBehaviour**(`opts`): `NodeCentralityBehaviour`
...
> `readonly` **kind**: `"degree-size"` = `'degree-size'`
...
`Partial`\<[`NodeCentralityBehaviourOptions`](../interfaces/NodeCentralityBehaviourOptions.md)\>
