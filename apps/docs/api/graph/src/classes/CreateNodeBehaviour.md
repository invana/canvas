...
- [`Behaviour`](../../../canvas/src/classes/Behaviour.md)\<[`CreateNodeBehaviourOptions`](../interfaces/CreateNodeBehaviourOptions.md)\>
...
> `protected` **\_options**: [`CreateNodeBehaviourOptions`](../interfaces/CreateNodeBehaviourOptions.md)
...
> `readonly` **kind**: `"create-node"` = `'create-node'`
