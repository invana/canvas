...
> **new TextLODBehaviour**(`opts`): `TextLODBehaviour`
...
[`IconLODBehaviour`](IconLODBehaviour.md).[`layer`](IconLODBehaviour.md#layer)
...
> `protected` **isNodeExempt**(`id`): `boolean`
...
`Partial`\<[`TextLODBehaviourOptions`](../interfaces/TextLODBehaviourOptions.md)\>
