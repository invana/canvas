...
Defined in: [graph-layout-d3-sankey/src/types.ts:17](https://github.com/invana/canvas/blob/1a808c5a9a1fe77fb1c6d5a7dcaf728db16cdbd4/packages/graph-layout-d3-sankey/src/types.ts#L17)
