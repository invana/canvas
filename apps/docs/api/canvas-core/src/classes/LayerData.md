...
> **get** **positions**(): [`ColumnStore`](ColumnStore.md)\<[`PosSchema`](../type-aliases/PosSchema.md)\>
...
[`ColumnStore`](ColumnStore.md)\<[`PosSchema`](../type-aliases/PosSchema.md)\>
...
[DataSource](../interfaces/DataSource.md) contract — alias for `on('flush', …)`.
...
Choose **when** a flush fires ([FlushMode](../type-aliases/FlushMode.md)). `'manual'` disarms any pending
