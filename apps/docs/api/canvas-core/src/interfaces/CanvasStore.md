...
> `readonly` **data**: `Record`\<`string`, [`DataSource`](DataSource.md)\>

Owned data, keyed by **source** id (D13 — each a [DataSource](DataSource.md)).
...
> `readonly` **specs**: `Record`\<`string`, [`SpecStore`](../classes/SpecStore.md)\>
...
> `readonly` **theme**: [`CanvasThemeState`](../classes/CanvasThemeState.md)
...
> `readonly` **view**: [`ReactiveStore`](ReactiveStore.md)\<[`CanvasView`](CanvasView.md)\>
...
Register a domain [DataSource](DataSource.md) under `id` (D13) — e.g. `@invana/graph`'s
`GraphStore`. Its [DataSource.onFlush](DataSource.md#onflush) is bridged onto [events](#events) as
...
> **source**(`id`): [`DataSource`](DataSource.md)

The [DataSource](DataSource.md) registered for `id`, or `undefined`.
...
> **specsFor**\<`T`\>(`id`): [`SpecStore`](../classes/SpecStore.md)\<`T`\>

Get (lazily creating) the [SpecStore](../classes/SpecStore.md) for layer `id`; its flush is
...
[`SpecStore`](../classes/SpecStore.md)\<`T`\>
