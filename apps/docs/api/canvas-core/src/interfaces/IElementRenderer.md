...
> `readonly` **events**: [`EventEmitter`](../classes/EventEmitter.md)\<[`ElementEventMap`](ElementEventMap.md)\>
...
`TSpec` *extends* [`BaseConnectorSpec`](BaseConnectorSpec.md)
...
`TSpec` *extends* [`BaseShapeSpec`](BaseShapeSpec.md)
...
> **boundsOfSpec**(`spec`): [`Rect`](Rect.md)
...
> **getConnectorPolyline**(`id`): readonly [`Point`](Point.md)[]
...
> **getDecorationWorldBounds**(`targetId`, `slot`): [`Rect`](Rect.md)
...
> **getShapeCenter**(`id`): [`Point`](Point.md)
...
> **getShapePosition**(`id`): [`Point`](Point.md)
...
> **getShapeWorldBounds**(`id`): [`Rect`](Rect.md)
...
> **hitTest**(`worldX`, `worldY`, `exclude?`): [`HitResult`](HitResult.md)
...
[`DecorationSpec`](DecorationSpec.md)\<`TStyle`\>
...
[`EffectSpec`](EffectSpec.md)\<`TStyle`\>
