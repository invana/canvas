...
- [`Behaviour`](Behaviour.md)\<[`DragShapeBehaviourOptions`](../interfaces/DragShapeBehaviourOptions.md)\>
...
> `protected` **\_options**: [`DragShapeBehaviourOptions`](../interfaces/DragShapeBehaviourOptions.md)
...
> `readonly` **kind**: `"drag-shape"` = `'drag-shape'`
