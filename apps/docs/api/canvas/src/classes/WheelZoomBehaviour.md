...
- [`Behaviour`](Behaviour.md)\<[`WheelZoomBehaviourOptions`](../interfaces/WheelZoomBehaviourOptions.md)\>
...
> `protected` **\_options**: [`WheelZoomBehaviourOptions`](../interfaces/WheelZoomBehaviourOptions.md)
...
> `readonly` **kind**: `"wheel-zoom"` = `'wheel-zoom'`
