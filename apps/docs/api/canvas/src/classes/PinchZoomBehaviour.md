...
- [`Behaviour`](Behaviour.md)\<[`PinchZoomBehaviourOptions`](../interfaces/PinchZoomBehaviourOptions.md)\>
...
> `protected` **\_options**: [`PinchZoomBehaviourOptions`](../interfaces/PinchZoomBehaviourOptions.md)
...
> `readonly` **kind**: `"pinch-zoom"` = `'pinch-zoom'`
