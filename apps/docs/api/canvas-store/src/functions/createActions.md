...
where a *custom* [DataSource](../../../canvas/src/interfaces/DataSource.md) was registered via `setSource` — e.g.
...
[`ReactiveStore`](../../../canvas/src/interfaces/ReactiveStore.md)\<[`CanvasView`](../../../canvas/src/interfaces/CanvasView.md)\>
