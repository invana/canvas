...
Defined in: [graph-layer-d3-contour/src/types.ts:11](https://github.com/invana/canvas/blob/1a808c5a9a1fe77fb1c6d5a7dcaf728db16cdbd4/packages/graph-layer-d3-contour/src/types.ts#L11)
