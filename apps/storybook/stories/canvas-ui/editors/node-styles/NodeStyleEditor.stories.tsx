/**
 * `<NodeStyleEditor>` — the **dispatcher**: it renders `SimpleNodeStyleEditor`
 * or `CompositeNodeStyleEditor` based on the `kind` prop. Docked into a live
