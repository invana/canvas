...
export const Layered: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const nodes: GraphNode[] = [
      { type: 'node', id: 'source',  style: { labelText: 'source',  bgFill: 0x0ea5e9 } },
      { type: 'node', id: 'lint',    style: { labelText: 'lint',    bgFill: 0x6366f1 } },
      { type: 'node', id: 'types',   style: { labelText: 'types',   bgFill: 0x6366f1 } },
      { type: 'node', id: 'build',   style: { labelText: 'build',   bgFill: 0x6366f1 } },
      { type: 'node', id: 'docs',    style: { labelText: 'docs',    bgFill: 0x6366f1 } },
      { type: 'node', id: 'unit',    style: { labelText: 'unit',    bgFill: 0xa855f7 } },
      { type: 'node', id: 'e2e',     style: { labelText: 'e2e',     bgFill: 0xa855f7 } },
      { type: 'node', id: 'bundle',  style: { labelText: 'bundle',  bgFill: 0xec4899 } },
      { type: 'node', id: 'release', style: { labelText: 'release', bgFill: 0xf43f5e } },
    ];
    const edges: GraphEdge[] = [
      { type: 'edge', id: 's-lint',     source: 'source', target: 'lint' },
      { type: 'edge', id: 's-types',    source: 'source', target: 'types' },
      { type: 'edge', id: 's-build',    source: 'source', target: 'build' },
      { type: 'edge', id: 's-docs',     source: 'source', target: 'docs' },
      { type: 'edge', id: 'lint-unit',  source: 'lint',   target: 'unit' },
      { type: 'edge', id: 'types-unit', source: 'types',  target: 'unit' },
      { type: 'edge', id: 'build-unit', source: 'build',  target: 'unit' },
      { type: 'edge', id: 'build-e2e',  source: 'build',  target: 'e2e' },
      { type: 'edge', id: 'unit-bundle', source: 'unit',  target: 'bundle' },
      { type: 'edge', id: 'e2e-bundle',  source: 'e2e',   target: 'bundle' },
      { type: 'edge', id: 'docs-release',   source: 'docs',   target: 'release' },
      { type: 'edge', id: 'bundle-release', source: 'bundle', target: 'release' },
    ];
