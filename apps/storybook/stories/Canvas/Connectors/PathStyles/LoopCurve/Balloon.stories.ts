...
const meta: Meta = { title: 'Canvas/Connectors/PathStyles/LoopCurve/Balloon' };
export default meta;
type Story = StoryObj;
...
export const Balloon: Story = {
  render: () => createContainer({ id: 'cvs-prim-loop-curve-balloon' }),
  ...
  play: async ({ canvasElement }) => {
    ...
    const container = canvasElement.querySelector<HTMLDivElement>('#cvs-prim-loop-curve-balloon')!;
    ...
    const layer = new RenderLayer({ id: 'loop-curve-balloon', options: {} });
