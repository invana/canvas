...
const meta: Meta = { title: 'Canvas/Draw/Connectors/Curve' };
export default meta;
type Story = StoryObj;

export const Curve: Story = {
  render: () => createContainer({ id: 'cvs-draw-curve' }),
  ...
  play: async ({ canvasElement }) => {
    ...
    const container = canvasElement.querySelector<HTMLDivElement>('#cvs-draw-curve')!;
    ...
    const layer = new DrawLayer({ id: 'curve-layer', options: {} });
    canvas.layers.add(layer);
    const g = layer.createGraphics('curve-gfx');
