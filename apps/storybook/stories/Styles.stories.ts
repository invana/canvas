...
const generateGraphData = (): CanvasData => ({
  nodes: [
    ...
    { id: 'n4', x: -150, y: 80, shape: 'roundedRect', width: 80, height: 50, label: 'Node 4', style: { fill: '#ffd93d', stroke: '#ccae30', strokeWidth: 2 } },
    ...
    const canvas = new Canvas({
      ...
      data: {
        nodes: [
          ...
          { id: 'b1', x: 100, y: -50, shape: 'roundedRect', width: 70, height: 45, label: 'B1', style: { fill: '#50c878', stroke: '#333', strokeWidth: 2 } },
          { id: 'b2', x: 200, y: -50, shape: 'roundedRect', width: 70, height: 45, label: 'B2', style: { fill: '#50c878', stroke: '#333', strokeWidth: 2 } },
