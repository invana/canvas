      ...
      const canvas = new Canvas({
        ...
        data: {
          nodes: [
            ...
            { id: 'doc-1', x: 0, y: -100, label: 'Doc A', shape: 'roundedRect', width: 80, height: 50, style: { fill: '#f39c12', stroke: '#333', strokeWidth: 2 } },
            { id: 'doc-2', x: 0, y: 100, label: 'Doc B', shape: 'roundedRect', width: 80, height: 50, style: { fill: '#f39c12', stroke: '#333', strokeWidth: 2 } },
          ],
          edges: [
