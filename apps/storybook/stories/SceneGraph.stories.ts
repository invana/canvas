  ...
  render: () => {
    ...
    setTimeout(async () => {
      const initialData: CanvasData = {
        nodes: [
          { id: 'n1', x: -100, y: -50, shape: 'circle', size: 40, label: 'Node 1', fill: '#4a90d9', stroke: '#333', strokeWidth: 2 },
          { id: 'n2', x: 100, y: -50, shape: 'circle', size: 40, label: 'Node 2', fill: '#50c878', stroke: '#333', strokeWidth: 2 },
  ...
  render: () => {
    ...
    setTimeout(async () => {
      const canvas = new Canvas({
        ...
        data: {
          nodes: [
            { id: 'user-1', x: -150, y: 0, label: 'Alice', shape: 'circle', size: 40, fill: '#e74c3c', stroke: '#333', strokeWidth: 2 },
            { id: 'user-2', x: 150, y: 0, label: 'Bob', shape: 'circle', size: 40, fill: '#3498db', stroke: '#333', strokeWidth: 2 },
            { id: 'doc-1', x: 0, y: -100, label: 'Doc A', shape: 'roundedRect', width: 80, height: 50, fill: '#f39c12', stroke: '#333', strokeWidth: 2 },
            { id: 'doc-2', x: 0, y: 100, label: 'Doc B', shape: 'roundedRect', width: 80, height: 50, fill: '#f39c12', stroke: '#333', strokeWidth: 2 },
          ],
          edges: [
            { id: 'owns-1', source: 'user-1', target: 'doc-1', pathType: 'line', arrowTarget: 'triangle', stroke: '#666', strokeWidth: 2 },
            { id: 'owns-2', source: 'user-2', target: 'doc-1', pathType: 'line', arrowTarget: 'triangle', stroke: '#666', strokeWidth: 2 },
            { id: 'owns-3', source: 'user-1', target: 'doc-2', pathType: 'line', arrowTarget: 'triangle', stroke: '#666', strokeWidth: 2 },
          ],
        },
      });
