...
const generateGraphData = () => ({
  nodes: [
    { 
      data: { id: 'n1', x: -200, y: -100, shape: 'circle' as const, size: 40, label: 'Node 1' },
    ...
    { 
      data: { id: 'n3', x: -200, y: 100, shape: 'diamond' as const, size: 50, label: 'Node 3' },
      style: { fill: '#ff6b6b', stroke: '#333', strokeWidth: 2 }
    },
    { 
      data: { id: 'n4', x: 200, y: 100, shape: 'hexagon' as const, size: 45, label: 'Node 4' },
      style: { fill: '#ffd93d', stroke: '#333', strokeWidth: 2 }
    },
    { 
      data: { id: 'n5', x: 0, y: 0, shape: 'ellipse' as const, width: 100, height: 60, label: 'Center' },
      style: { fill: '#6c5ce7', stroke: '#333', strokeWidth: 2 }
    },
  ],
  edges: [
    { 
      data: { id: 'e1', source: 'n1', target: 'n5', pathType: 'bezier' as const },
      style: { stroke: '#666', strokeWidth: 2 }
    },
    { 
      data: { id: 'e2', source: 'n2', target: 'n5', pathType: 'bezier' as const },
      style: { stroke: '#666', strokeWidth: 2 }
    },
    { 
      data: { id: 'e3', source: 'n3', target: 'n5', pathType: 'bezier' as const },
      style: { stroke: '#666', strokeWidth: 2 }
    },
    { 
      data: { id: 'e4', source: 'n4', target: 'n5', pathType: 'bezier' as const },
      style: { stroke: '#666', strokeWidth: 2 }
    },
  ],
});
